...
def construct_data(model):
    return mujoco.MjData(model)


def get_joint_and_actuator_ids(model):
    joint_names = []
    velocity_limits = {}
...
def construct_collision_pairs(model):
...
def construct_limits(model, joint_names, velocity_limits, collision_pairs):
