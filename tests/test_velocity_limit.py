...
class TestVelocityLimit(absltest.TestCase):
    ...
    def test_dimensions(self):
        ...
        self.assertTrue(np.array_equal(limit.projection_matrix.shape, (nv, nv)))
    ...
    def test_model_with_subset_of_velocities_limited(self):
        ...
        nb = 3
        nv = self.model.nv
        self.assertTrue(np.array_equal(limit.projection_matrix.shape, (nb, nv)))
    ...
    def test_model_with_ball_joint(self):
        ...
        nb = 3 + 1
        self.assertEqual(len(limit.indices), nb)
        self.assertTrue(np.array_equal(limit.projection_matrix.shape, (nb, model.nv)))
